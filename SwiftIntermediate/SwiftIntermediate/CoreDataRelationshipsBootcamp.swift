...
class CoreDataRelationshipViewModel: ObservableObject {
    ...
    let manager = CoreDataManager.instance // Singleton instance
    ...
    func getEmployees(forBusiness business: BusinessEntity) {
        let request = NSFetchRequest<EmployeeEntity>(entityName: "EmployeeEntity")
        // filter (주의) employee가 business를 한 개만 갖기 때문에 이러한 필터가 가능함
    ...
    func addDepartment() {
        ...
        newDepartment.businesses = [businesses[0], businesses[1], businesses[3]] // NSSet
